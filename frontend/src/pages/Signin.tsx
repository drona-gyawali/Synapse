...
export const defaultInputStyle = "w-full pl-4 pr-4 py-3 font-light border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all";
             ...
             <div className="w-full md:w-1/2 flex flex-col justify-center items-center bg-white p-8 lg:p-20">
                <div className="w-full max-w-sm">
                    ...
                    <div className="text-center mb-10">
                        ...
                        <p className="text-gray-500 mt-2 text-sm">Save and Share your brain! Please enter your details.</p>
                    </div>
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <Input 
                         ...
                         type="text" style={defaultInputStyle} placeholder="Username"/>
